...
<div class="rp-page">
    ...
    <div class="filter-card">
        <form method="get" action="index.php">
            <input type="hidden" name="action" value="owner_report_booking" />
            <div class="filter-row">
                ...
                <div class="field" style="flex:0">
                    <label>&nbsp;</label>
                    <a href="index.php?action=owner_report_booking" class="btn">Reset</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="table-card">
        <div class="table-head"><h3>Thống kê theo sân</h3></div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?= $c['total'] > 0 ? number_format($c['cancelled']/$c['total']*100, 1) : 0 ?>%</td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
(function(){
    new Chart(document.getElementById('chartStatus'), {
        ...
        data: {
            ...
            datasets: [{ data: [<?= $confirmed ?>, <?= $pending ?>, <?= $cancelled ?>], backgroundColor: ['#00c07f','#f59e0b','#f43f5e'], borderWidth: 0, hoverOffset: 6 }]
        },
    ...
    new Chart(document.getElementById('chartCourt'), {
        ...
        options: { plugins: { legend: { position: 'bottom', labels: { font: { weight: '700' }, padding: 12 } } }, scales: { x: { grid: { display: false } }, y: { beginAtZero: true } } }
    });
})();
</script>
