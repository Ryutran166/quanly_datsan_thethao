...
<div class="ab-page">
    ...
    <div class="ab-header">
        ...
        <a href="?action=admin_payment_search" class="btn-ok" style="height:fit-content; padding:8px 14px;">
                ...
                <div class="ab-info">
                    ...
                    <div class="ab-meta">
                        ...
                        <div class="ab-meta-item">
                            ...
                            <?php
                                $firstSlot = $b['slots'][0] ?? null;
                                if ($firstSlot) {
                                    echo substr($firstSlot['start_time'],0,5).' – '.substr($firstSlot['end_time'],0,5);
                                } else {
                                    echo '—';
                                }
                            ?>
                    ...
                    <?php if (!empty($b['slots'])): ?>
                        <div style="margin-top:10px; font-size:12px; color:var(--mid);">
                            <div style="font-weight:800; color:var(--dark); margin-bottom:6px;">Các khung giờ:</div>
